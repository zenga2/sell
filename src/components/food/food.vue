    ...
    export default {
        ...
        methods: {
            ...
            selectRating(type) {
                ...
                this.$nextTick(() => {
                    this.scroll.refresh()
                    this.scroll.scrollToElement(this.$refs.ratingWrapper, 0)
                })
            },
            toggleContent() {
            ...
            formateDate(time) {
                return formateDate(new Date(time), 'yyyy-MM-dd hh:mm')
            }
        },
...
<style lang="stylus" rel="stylesheet/stylus">
    ...
    .food
        ...
        v-transition(move, {transition: all 0.2s linear}, {
        ...
        .content
            ...
            .buy
                ...
                opacity: 1
                v-transition(fade, {transition: all 0.2s}, {
                    opacity: 0
                    z-index : -1
                })
